...
internal val logger: SkipLogger = SkipLogger(subsystem = "cup.module", category = "Cup")

private typealias AppRootView = CupRootView
private typealias AppDelegate = CupAppDelegate
