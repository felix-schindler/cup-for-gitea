...
The app icons can be generated by using the following command: `$ skip icon --open-preview --background="#C7E9C0-#60B27A" symbol.svg`.
...
mv openapi.required.yaml ./Sources/GiteaAPI/openapi.yaml
```
